jQuery(document).ready(function($) {		
	...
	if(jQuery('article.format-video .post-thumb').length != 0){	
		jQuery('article.format-video .post-thumb').hover(
			function(){
				jQuery('.video img',this).attr('src', jQuery('.video img',this).attr('src').replace('.png','http://goccina.com.tr/-a.png') );
			},
			function(){
				jQuery('.video img',this).attr('src', jQuery('.video img',this).attr('src').replace('http://goccina.com.tr/-a.png','.png') );
			}
		);	
	}
	...
	if(jQuery('.grid .brick .featuredi').length != 0){	
		jQuery(document).on('mouseover', '.grid .brick .featuredi', function() {
			jQuery('.video',this).attr('src', jQuery('.video',this).attr('src').replace('.png','http://goccina.com.tr/-a.png') );
		});
		jQuery(document).on('mouseout', '.grid .brick .featuredi', function() {
			jQuery('.video',this).attr('src', jQuery('.video',this).attr('src').replace('http://goccina.com.tr/-a.png','.png') );
		});
	}
